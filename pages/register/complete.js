    ...
    <Layout>
      ...
      >
        <div class="-mt-24">
          ...
          >
            Now you can post and comment and sharing your idea to our community.
          </p>
          <button
            class="focus:outline-none rounded-2xl"
            style={{ width: 'auto', backgroundColor: '#52C587' }}
          >
            <Link href="/login">
              <p
                class="px-12 pb-1 pt-2"
                style={{
              ...
              >
                Let’s explore our community NOW!!!
              </p>
            </Link>
          </button>
        </div>
