            ...
            <div class = "px-20  pt-12 pb-8">
                <div class = "flex justify-end">
                    ...
                    </div>
                    {
                        username?(
                            <>
                                <Link href = "/myposts"><a class="inline-block">
                                    <div class = "-mt-2 rounded-lg text-xl relative" style={{"height":"50px","backgroundColor":(admin?"#123D6A":"#FFFFFF")}}>
                                        ...
                                        <p class = "pl-12 pr-2" style={{"color":(admin?"#FFFFFF":"#000000"),"fontFamily":"Quark-Bold","fontSize":"18px","transform": "translate(0, 50%)"}}>{username}</p>
                                    </div>
                                </a></Link>
                            </>
                        ):(
